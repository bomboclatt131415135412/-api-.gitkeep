...
config = {
    ...
    "image": "https://th.bing.com/th/id/OIP.reKAuVh8fERc12JoYJaDAAHaFj?w=253&h=190&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", # You can also have a custom image by using a URL argument
